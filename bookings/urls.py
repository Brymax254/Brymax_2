...
urlpatterns += [
    ...
    # 👷 Custom Admin Driver Action (Fixes NoReverseMatch)
    path("driver/action/<int:driver_id>/", views.driver_action, name="driver_action"),
]
...
urlpatterns += [
    ...
    path("api/", include(router.urls)),  # Includes all DRF routes
]
